...
- Formula: unsigned tarballs containing `bin/swift-s3-gateway`.
...
dist/homebrew/swift-s3-gateway-<version>-darwin-arm64.tar.gz.sha256
dist/homebrew/swift-s3-gateway-<version>-darwin-x64.tar.gz
dist/homebrew/swift-s3-gateway-<version>-darwin-x64.tar.gz.sha256
```
...
```bash
scripts/render-homebrew-formula.sh <version> ../homebrew-tap/Formula/swift-s3-gateway.rb
```
...
dist/homebrew-cask/swift-s3-gateway-<version>-darwin-arm64.dmg.sha256
dist/homebrew-cask/swift-s3-gateway-<version>-darwin-x64.dmg
dist/homebrew-cask/swift-s3-gateway-<version>-darwin-x64.dmg.sha256
```

Render the Cask:

```bash
scripts/render-homebrew-cask.sh <version> ../homebrew-tap/Casks/swift-s3-gateway.rb
```
